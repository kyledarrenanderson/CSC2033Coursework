...
let randomWords = new Map([
        ...
        ['test-environment-setup', 'programming language'],
        ...
        ['acceptance-testing', 'In this type of software testing, users and customers determine whether the software is conforming specified requirements or not.", "answer'],
